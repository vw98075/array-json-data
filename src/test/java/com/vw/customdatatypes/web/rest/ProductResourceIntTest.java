...
import static com.vw.customdatatypes.web.rest.TestUtil.createFormattingConversionService;
...
public class ProductResourceIntTest {
    ...
    private static final Map<String, String> DEFAULT_SPECS = buildMap("AAAAAAAAAA", "XXX");
    private static final Map<String, String> UPDATED_SPECS = buildMap("BBBBBBBBBB", "YYYY");

    private static final String DEFAULT_SEASON = "AAAAAAAAAA";
    private static final String UPDATED_SEASON = "BBBBBBBBBB";

    public static Map buildMap(String str1, String str2) {
     ...
     *
     * @see com.vw.customdatatypes.repository.search.ProductSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].specs").value(hasItem(DEFAULT_SPECS.toString())))
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.specs").value(DEFAULT_SPECS.toString()))
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getSpecs()).isEqualTo(UPDATED_SPECS);
        assertThat(testProduct.getSeason()).isEqualTo(UPDATED_SEASON);
